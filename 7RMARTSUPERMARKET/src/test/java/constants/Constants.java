...
public class Constants {
	...
	public static final String lp_verifyLoginWithInValidUsernameAndInvalidPassword ="login is possible with invalid username and invalid password";public static final String MP_verifyUserIsAbleToAddNewCategoryWithValidDetails="Category Created Successfully alert message is not displayed";
